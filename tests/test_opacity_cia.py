...
def test_cia_wn_order():
    # Order of wn array does not matter:
    cs_file = 'CIA_Borysow_H2H2_0060-7000K_0.6-500um.dat'
    wn1 = wn
    wn2 = wn[::-1]
    cia1 = op.Collision_Induced(f'{c_root}{cs_file}', wn1)
    cia2 = op.Collision_Induced(f'{c_root}{cs_file}', wn2)
...
def test_cia_single_mismatch():
    ...
    with pytest.raises(ValueError, match=error):
        extinction = cia.calc_extinction_coefficient(temp, densities)
