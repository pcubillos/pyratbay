...
class Hitran(Linelist):
    ...
    def __init__(self, dbfile, pffile, log):
        ...
        self.rec_iso      =   2 # Isotope position
        self.rec_wn       =   3 # Wavenumber position
        self.rec_strength =  15 # Line intensity position
        self.rec_A21      =  25 # Einstein coef position
        self.rec_air      =  35 # Air broadening position
        self.rec_elow     =  45 # Lower Energy position
        self.rec_elow_end =  55 # Lower Energy end position
        self.rec_g2       = 146 # Upper state weight position
